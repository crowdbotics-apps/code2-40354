"""
Django settings for code2_40354 project.
...
WSGI_APPLICATION = 'code2_40354.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "code2_40354 API",
    "DESCRIPTION": "API documentation for code2_40354 App",
    "VERSION": "v1",
}
